        ...
        <div className='flex items-center justify-center p-8 bg-background '>
            <div className='rounded-lg border bg-card text-card-foreground shadow-sm w-full max-w-md shadow-medium'>
                <div className='flex flex-col p-6 text-center space-y-2'>
                    <h3>Connexion</h3>
                    <p className='text-sm text-muted-foreground '>Connectez vous à votre compte  EarthConnect</p>
                </div>
                <div className='p-6 pt-0 space-y-6'>
                    <form action="" className='space-y-4' onSubmit= {handleSubmit}>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative mt-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-lock-icon lucide-lock absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-muted-foreground "><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between text-sm">
                                <label htmlFor="remember" className="flex items-center space-x-2 cursor-pointer">
                                    <input name="rembered" id="remember" type="checkbox" className="rounded border-border" />
                    ...
                    <div className="space-y-3">
                        <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 ring-custom focus-visible:ring-offset-2 disabled:pointer-events-none border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 py-2 px-4 w-full">
                            <svg data-lov-id="src/pages/Register.tsx:292:16" data-lov-name="svg" data-component-path="src/pages/Register.tsx" data-component-line="292" data-component-file="Register.tsx" data-component-name="svg" data-component-content="%7B%22className%22%3A%22w-4%20h-4%20mr-2%22%7D" class="w-4 h-4 mr-2" viewBox="0 0 24 24"><path data-lov-id="src/pages/Register.tsx:293:18" data-lov-name="path" data-component-path="src/pages/Register.tsx" data-component-line="293" data-component-file="Register.tsx" data-component-name="path" data-component-content="%7B%7D" fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"></path><path data-lov-id="src/pages/Register.tsx:294:18" data-lov-name="path" data-component-path="src/pages/Register.tsx" data-component-line="294" data-component-file="Register.tsx" data-component-name="path" data-component-content="%7B%7D" fill="currentColor" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"></path><path data-lov-id="src/pages/Register.tsx:295:18" data-lov-name="path" data-component-path="src/pages/Register.tsx" data-component-line="295" data-component-file="Register.tsx" data-component-name="path" data-component-content="%7B%7D" fill="currentColor" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"></path><path data-lov-id="src/pages/Register.tsx:296:18" data-lov-name="path" data-component-path="src/pages/Register.tsx" data-component-line="296" data-component-file="Register.tsx" data-component-name="path" data-component-content="%7B%7D" fill="currentColor" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"></path></svg>
                            Continuer avec Google
                        </button>
                        <button className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 ring-custom focus-visible:ring-offset-2 disabled:pointer-events-none border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 py-2 px-4 w-full">
                            <svg data-lov-id="src/pages/Register.tsx:302:16" data-lov-name="svg" data-component-path="src/pages/Register.tsx" data-component-line="302" data-component-file="Register.tsx" data-component-name="svg" data-component-content="%7B%22className%22%3A%22w-4%20h-4%20mr-2%22%7D" class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24"><path data-lov-id="src/pages/Register.tsx:303:18" data-lov-name="path" data-component-path="src/pages/Register.tsx" data-component-line="303" data-component-file="Register.tsx" data-component-name="path" data-component-content="%7B%7D" d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"></path></svg>
